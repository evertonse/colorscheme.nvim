...
theme.set_highlights = function(opts)
    ...
    hl(0, 'Identifier', { fg = vscLightBlue,  bg = 'NONE' })
    ...
    hl(0, '@namespace', { fg = c.vsNamespace, bg = 'NONE' })
    ...
    hl(0, '@field', { fg = c.vsProperty, bg = 'NONE' })
    ...
    hl(0, '@include', { fg = c.vsGrey , bg = 'NONE' })
    hl(0, '@variable', { fg = c.scLightBlue, bg = 'NONE' })
