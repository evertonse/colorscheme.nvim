...
local base = {
  ...
  hl(0, 'Comment',       { fg = c.vsComment, bg = 'NONE', italic = opts.italic_comments })
  ...
  hl(0, 'PreProc',       { fg = c.vsGrey, bg = 'NONE' })
  hl(0, 'Include',       { fg = c.vsGrey, bg = 'NONE' })
  hl(0, 'pragma',       { fg = c.vsGrey, bg = 'NONE' })
  hl(0, 'Define',        { fg = c.vsGrey, bg = 'NONE' })
  hl(0, 'Macro',         { fg = c.vsGrey, bg = 'NONE' })
  hl(0, 'Type',          { fg = c.vsType, bg = 'NONE' })
  hl(0, 'StorageClass',  { fg = c.vsType, bg = 'NONE' })
  hl(0, 'Structure',     { fg = c.vsType, bg = 'NONE' })
  hl(0, 'Typedef',       { fg = c.vsType, bg = 'NONE' })
  ...
  hl(0, 'SpecialComment',{ fg = c.vsComment, bg = 'NONE' })
